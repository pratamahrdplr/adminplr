...
$query=mysql_query("insert into tb_user (kode_user, username_user, password_user , nama_user, level_user, hp_user, kota) values ('$_POST[level]' , '$_POST[username]' , '$_POST[pass]' , '$_POST[nama]','$_POST[level]', '$_POST[hp]', '$_POST[kota_user]')") or die (mysql_error());
if($query)
